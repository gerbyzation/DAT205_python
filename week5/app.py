...
path = "/Users/gerbenneven/Library/Application Support/Google/Chrome/Default/History"
...
response = api.PostUpdate("I visited " + title + " " + nView + " times in #Chrome #pythonbot #wearecoming")
